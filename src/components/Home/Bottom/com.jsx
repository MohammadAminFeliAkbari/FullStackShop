...
export default function Com({ information, numberStart, img, price, offer }) {
    return (
        <div className="w-[280px] choping-card items-center justify-center text-center shadow-md hover:scale-105 transition-all rounded-sm p-3 ">
            <div className="img-section flex flex-col items-center justify-center relative">
                <img className="h-[200px] rounded" src={img} alt={information} />
                {offer && (
